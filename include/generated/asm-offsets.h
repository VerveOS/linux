...
#define THREAD_SCTLR_USER 4288 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4184 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4264 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4280 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 2856 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
